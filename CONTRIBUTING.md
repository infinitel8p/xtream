...
Thanks for considering a contribution. This is a small project with a single maintainer; the bar isn't high but a little structure helps everyone.

## Before you open a PR

- For non-trivial changes (new features, refactors, anything that touches design / UX), please open an issue or discussion first so we can align on the approach. PRs that arrive cold with a big diff often need redirection.
- Bug fixes, typos, doc improvements, and small UX tweaks are fine to send directly.
